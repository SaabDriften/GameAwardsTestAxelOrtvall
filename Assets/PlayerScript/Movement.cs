...
public class Movement : MonoBehaviour
{
    ...
    {
        Vector2 originTop = new Vector2(pos.x + direction * .0f, pos.y + 1f - 0.2f);
        Vector2 originMiddle = new Vector2(pos.x + direction * .0f, pos.y);
        Vector2 originBottom = new Vector2(pos.x + direction * .0f, pos.y - 1f + 0.2f);
    ...
    {
        Vector2 originLeft = new Vector2(pos.x - 0.5f + 0.2f, pos.y - 0.1f);
        Vector2 originMiddle = new Vector2(pos.x, pos.y - 1f);
        Vector2 originRight = new Vector2(pos.x + 0.5f - 0.2f, pos.y - 0.1f);
